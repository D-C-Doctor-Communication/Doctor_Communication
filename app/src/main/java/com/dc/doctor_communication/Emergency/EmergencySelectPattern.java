...
import com.dc.doctor_communication.SymptomRegistration.ListViewAdapter;
import com.dc.doctor_communication.SymptomRegistration.SelectLevel;
import com.dc.doctor_communication.SymptomRegistration.SelectWorse;
...
public class EmergencySelectPattern extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        nextpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(EmergencySelectPattern.this, SelectWorse.class);
                ...
                if(select_pattern.length==0){
                    new AlertDialog.Builder(EmergencySelectPattern.this)
        ...
        backpage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmergencySelectPattern.this, SelectLevel.class);
                intent.putExtra("symptom",symptom);
                intent.putExtra("part",part);
                intent.putExtra("bparts",selected_body);
                intent.putExtra("repeat",repeat);
